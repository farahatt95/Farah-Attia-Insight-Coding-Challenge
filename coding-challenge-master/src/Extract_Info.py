...
save_path = '..\\insight_testsuite\\tests\\test-1-venmo-trans\\venmo_output'
...
save_path = '..\\insight_testsuite\\tests\\test-1-venmo-trans\\venmo_input'
saveFile = os.path.join(save_path, "venmo-trans.txt")
print main(saveFile)
outputFile.close()
